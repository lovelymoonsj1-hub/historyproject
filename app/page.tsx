...
const referenceVisuals: ReferenceVisual[] = [
  ...
  { terms: ["\ub3d9\ubd81 9\uc131", "\uc724\uad00", "\ubcc4\ubb34\ubc18"], src: "/images/reference/northeast-nine-fortresses-map.svg", title: "\ub3d9\ubd81 9\uc131\uc758 \uc704\uce58", note: "\ub3d9\ubd81 9\uc131\uc740 \uace0\ub824\uc758 \ubd81\ub3d9\ucabd \uacbd\uacc4, \ud568\ud765\ud3c9\uc57c\uc640 \uae38\uc8fc \uc77c\ub300\uc5d0 \uc124\uce58\ub41c \uc131\ub4e4\uc744 \ub73b\ud574\uc694. \uc815\ud655\ud55c \uc131\uc758 \uc704\uce58\uc5d0\ub294 \ud559\uc124 \ucc28\uc774\uac00 \uc788\uc5b4 \ubc94\uc704\ub85c \ud45c\uc2dc\ud588\uc5b4\uc694." },
  { terms: ["\uc704\ud654\ub3c4", "\uc0bc\ubcc4\ucd08", "\uac15\ud654\ub3c4", "\ud55c\uac15 \uc720\uc5ed", "\ubcbd\ub780\ub3c4", "\uccad\ud574\uc9c4", "\ubc1c\ud574", "\uac70\ub780", "\uc5ec\uc9c4", "\ub2f9", "\uc1a1", "\uc6d0", "\uba85", "\uccad\ub098\ub77c", "\ud55c\ub098\ub77c", "\uc9c4\ub098\ub77c", "\uc77c\ubcf8"], src: "/images/reference/korean-history-geography-map.svg", title: "\ud55c\uad6d\uc0ac \uc8fc\uc694 \uc9c0\ub9ac \uac1c\ub150", note: "\uc704\ud654\ub3c4\u00b7\uac15\ud654\ub3c4\u00b7\uc0bc\ubcc4\ucd08\u00b7\ubcbd\ub780\ub3c4\u00b7\uccad\ud574\uc9c4\u00b7\ub3d9\ubd81 9\uc131\uc758 \uc704\uce58\uc640, \ud55c\u00b7\uc9c4\u00b7\ub2f9\u00b7\uc1a1\u00b7\uc6d0\u00b7\uba85\u00b7\uccad, \uac70\ub780\u00b7\uc5ec\uc9c4\u00b7\ubc1c\ud574\uc640\uc758 \uad00\uacc4\ub97c \ud55c \ubc88\uc5d0 \ud655\uc778\ud574\ubcf4\uc138\uc694." },
...
const preferredVisualByTitle: Record<string, string> = {
  ...
  "\ub3d9\ubd81 9\uc131": "/images/reference/northeast-nine-fortresses-map.svg",
  "\uc704\ud654\ub3c4": "/images/reference/korean-history-geography-map.svg",
  "\uc0bc\ubcc4\ucd08": "/images/reference/korean-history-geography-map.svg",
  "\uac15\ud654\ub3c4": "/images/reference/korean-history-geography-map.svg",
  "\ud55c\uac15 \uc720\uc5ed": "/images/reference/korean-history-geography-map.svg",
  "\ubcbd\ub780\ub3c4": "/images/reference/korean-history-geography-map.svg",
  "\uccad\ud574\uc9c4": "/images/reference/korean-history-geography-map.svg",
  "\ubc1c\ud574": "/images/reference/korean-history-geography-map.svg",
  "\uac70\ub780": "/images/reference/korean-history-geography-map.svg",
  "\uc5ec\uc9c4": "/images/reference/korean-history-geography-map.svg",
  "\uccad\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\ub2f9\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\uc1a1\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\uc6d0\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\uba85\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\ud55c\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\uc9c4\ub098\ub77c": "/images/reference/korean-history-geography-map.svg",
  "\uc65c": "/images/reference/korean-history-geography-map.svg",
};
...
export default function Home() {
  ...
  return <main className="min-h-screen bg-[#fbf3e4] text-[#41382e]">{!referenceVisual && <section className="mx-auto max-w-6xl px-5 pt-3 md:px-10"><div className="rounded-2xl border border-[#e7d0af] bg-[#fffaf1] p-4 shadow-sm"><p className="text-sm font-black text-[#b36b2c]">개념 설명을 읽어 보세요</p><p className="mt-2 text-sm leading-6 text-stone-700">{selected.summary}</p><p className="mt-2 text-sm leading-6 text-stone-700">{selected.connection}</p><div className="mt-3 grid gap-2 sm:grid-cols-3">{selected.story.map((item) => <div key={item.label} className="rounded-xl bg-white/70 p-3"><p className="text-xs font-black text-[#57958f]">{item.label}</p><p className="mt-1 text-xs leading-5 text-stone-600">{item.value}</p></div>)}</div><a href={(officialSource ?? trustedSourceFor(selected)).url} target="_blank" rel="noreferrer" className="mt-3 inline-block text-xs font-bold text-[#397e79] underline underline-offset-2">출처 확인 · {(officialSource ?? trustedSourceFor(selected)).label}</a></div></section>}
    ...
    {showWelcome && !query ? <LandingHero onStart={() => setShowWelcome(false)} /> : <section className="mx-auto max-w-6xl px-5 py-9 md:px-10"><p className="text-xs font-bold text-[#d2744d]">{t.home}</p><h1 className="mt-2 text-4xl font-black tracking-tight md:text-5xl">{selected.title}</h1><p className="mt-2 text-stone-500">{selected.era} · {selected.years}</p>
      ...
      {learningMode && <section className={`${learningMode === "deep" ? "hidden" : ""} mt-4 rounded-[26px] border border-[#e2cfaf] bg-white p-6 shadow-sm`} aria-live="polite">
